    ...
    <>
      <style>{`
        ...
        .employee-page {
          ...
          padding: 2.5rem;
          background:
          radial-gradient(circle at 10% 20%, rgba(139,92,246,0.15), transparent 12%),
          radial-gradient(circle at 90% 80%, rgba(192,132,252,0.12), transparent 12%),
          linear-gradient(135deg, #faf5ff 0%, #f3e8ff 40%, #ede9fe 100%);
          overflow: hidden;
        }
        ...
        .gradient-anim {
          position: absolute;
          inset: -20%;
          background: linear-gradient(120deg, rgba(139,92,246,0.08), rgba(192,132,252,0.08), rgba(76,29,149,0.06));
        ...
        .employee-header {
          ...
          background: linear-gradient(135deg, #4c1d95, #6d28d9, #8b5cf6, #c084fc);
          color: #fff;
        }
        ...
        .btn-add { background: linear-gradient(135deg,#6d28d9,#8b5cf6,#c084fc); color: white; }
        .btn-add:hover { transform: translateY(-2px); }

        .btn-update { background: linear-gradient(135deg,#ede9fe,#ddd6fe); color: #6d28d9; border: 1px solid #c4b5fd; }
        ...
        tbody tr:hover { transform: translateY(-4px); box-shadow: 0 14px 36px rgba(139,92,246,0.10); background: rgba(245, 243, 255, 0.9); }
        ...
        .name-cell { font-weight: 800; font-size: 1.12rem; color: #4c1d95; }
        .role-cell { font-size: 1.02rem; color: #6d28d9; }
        .email-link { text-decoration: none; color: #7c3aed; font-weight: 700; }
        ...
        <div className="employee-card" role="region" aria-label="Employee Directory">
          <header className="employee-header">
            ...
            <div className="title-wrap">
              <h1 className="display-3">EmpTrack — Employee Management System</h1>
