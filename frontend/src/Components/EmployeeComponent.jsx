    ...
    <>
      <style>{`
        ...
        .employee-page {
           ...
           padding:2.5rem;
           background:
             radial-gradient(circle at 10% 20%, rgba(124,58,237,0.12), transparent 12%),
             radial-gradient(circle at 90% 80%, rgba(168,85,247,0.10), transparent 12%),
             linear-gradient(135deg, #f8f4ff 0%, #efe7ff 40%, #e6dcff 100%);
          }
